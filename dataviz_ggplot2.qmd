...
An diesem Beispiel haben wir gesehen, wie einfach wir mit `ggplot` Plots erzeugen können. Im Folgenden wollen wir euch noch eine Auswahl an Visualisierungsfunktionen vorstellen, die wir häufig benötigen.
